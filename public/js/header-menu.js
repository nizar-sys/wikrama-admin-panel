...
function renderHeaderMenu(menu) {
  var slug_title = menu.slug_title,
      title = menu.title,
      child_posts = menu.child_posts;
...
function getHeaderMenu() {
  return _getHeaderMenu.apply(this, arguments);
}

function _getHeaderMenu() {
  _getHeaderMenu = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var menus;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            $(".section-header-below").on("mouseenter", function (e) {
              ...
              if (hasChild) {
                ...
                $(".child-menu-".concat(childDropdown)).addClass("active-dropdown");
              }
            });
            $(".child-menus").on("mouseleave", function (e) {
              var parentDropdown = $(e.target).parent().data("parent");
              $(e.target).parent().removeClass("active-dropdown");
              $(".menu-".concat(parentDropdown)).removeClass("active-head-menu");
            });
