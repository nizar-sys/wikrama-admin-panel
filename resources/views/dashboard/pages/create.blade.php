@extends('layouts.app')
@section('title', 'Tambah Data Pages')

@section('title-header', 'Tambah Data Pages')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('pages.index') }}">Data Pages</a></li>
    <li class="breadcrumb-item active">Tambah Data Pages</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Pages</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('pages.store') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="col-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                        placeholder="Judul Pages" value="{{ old('title') }}" name="title">
                            ...
                            <div class="col-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('subtitle') is-invalid @enderror" id="subtitle"
                                        placeholder="SubJudul Pages" value="{{ old('subtitle') }}" name="subtitle">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('seo_key') is-invalid @enderror" id="seo_key"
                                        placeholder="SEO Key Pages, sepparated by comma (default)" value="{{ old('seo_key') }}" name="seo_key">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('seo_desc') is-invalid @enderror" id="seo_desc"
                                placeholder="SEO Description Pages" value="{{ old('seo_desc') }}" name="seo_desc">
